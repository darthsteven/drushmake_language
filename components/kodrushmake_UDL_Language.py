# Komodo drushmake language service.

import logging
from koUDLLanguageBase import KoUDLLanguage


log = logging.getLogger("kodrushmakeLanguage")
#log.setLevel(logging.DEBUG)


def registerLanguage(registry):
    log.debug("Registering language drushmake")
    registry.registerLanguage(KodrushmakeLanguage())


class KodrushmakeLanguage(KoUDLLanguage):
    name = "drushmake"
    lexresLangName = "drushmake"
